...
from caos.__main__ import _PREPARE_COMMAND, _PIP_COMMAND
...
class TestPip(unittest.TestCase):
    ...
    def test_run(self) -> None:           
        ...
        result = subprocess.check_output(
            args=[sys.executable, "-c", "from caos import console; console()", _PIP_COMMAND, "--version"],
            cwd="../../"
        ).decode("utf-8")

        self.assertTrue("pip" in result)
