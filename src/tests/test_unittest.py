...
from caos.__main__ import _INIT_COMMAND, _PREPARE_COMMAND, _UPDATE_COMMAND, _UNITTEST_COMMAND
...
class TestTest(unittest.TestCase):    
    ...
    def test_test(self) -> None:           
        ...
        sys.argv = [caos.common.constants._UNIT_TEST_SUITE_NAME, _UNITTEST_COMMAND, "./tests"]
        out = caos.common.utils.get_func_without_params_stdout(func=console)
